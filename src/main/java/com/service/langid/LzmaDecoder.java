...
class LzmaDecoder
{
	static class LenDecoder
	{
		...
		public int Decode(LzmaBitDecoder rangeDecoder, int posState) throws IOException
		{
	...
	static class LiteralDecoder
	{
		class Decoder2
		{
			...
			public byte DecodeNormal(LzmaBitDecoder rangeDecoder) throws IOException
			{
				int symbol = 1;
				do
			...
			public byte DecodeWithMatchByte(LzmaBitDecoder rangeDecoder, byte matchByte) throws IOException
			{
				int symbol = 1;
				do
				{
	...
	LzmaBitDecoder m_RangeDecoder = new LzmaBitDecoder();
